...
from mini_jvm.runtime import (
    VM, ClassDef, Method, ObjRef,
    LOAD_LOCAL, STORE_LOCAL, PUSH_CONST, IADD, RETURN, CALL_VIRT, CALL_STATIC
)
...
def test_inheritance():
    ...
    derived_class = ClassDef("Derived", base_class, methods={"method": derived_method}, static_methods={})
...
def test_frame_stack():
    ...
    assert vm.frames[-1].method == method
